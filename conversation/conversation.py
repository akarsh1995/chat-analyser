...
class Conversation():
    ...
    def media_count(self):
        if self._messages_are_present:
            return sum([m.is_media for m in self._messages])
    ...
    def save_wordcloud(self):
        ...
        WordCloudGenerate(text).save_wordcloud()
    ...
    def longest_continue_conversation(self, timegap):
        ...
        return f"The longest converstaion starts {starts_at} and ends {ends_at}, duration: " \
